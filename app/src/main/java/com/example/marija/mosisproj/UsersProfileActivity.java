...
public class UsersProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        kljuc=getIntent().getStringExtra("kljuc");
        ...
        if(user!=null) {
            ...
            dref.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(final DataSnapshot dataSnapshot) {
                    ...
                    Korisnik t = dataSnapshot.child("user").child(kljuc).getValue(Korisnik.class);
                    ...
                    StorageReference sRef = storageRef.child(kljuc + ".jpg");



                    File localFile = null;
                    try {
                        localFile = File.createTempFile(kljuc, "jpg");
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
